            ...
            <Stepper activeStep={3}>
              <div className="w-full bg-white">
                ...
                >
                        ...
                        label={
                          <div className="flex items-center gap-4">
                            <img
                              ...
                              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT08FpvDoIXUDGdRJ2iFh0FOqegvJjOgoHKZT6wXXnLjA&s"
                              alt="cod Logo"
                            />
                            <span>COD</span>
                          </div>
                  ...
                  <input
                    type="submit"
                    value={`Thanh toán ${totalPrice.toLocaleString()} ₫`}
